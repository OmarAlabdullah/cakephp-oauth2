                    ...
                    <xsl:for-each select="file">
                        <xsl:for-each select="violation">
                            <tr>
                                ...
                                <td style="padding: 3px" align="left"><a><xsl:attribute name="href">../ws/src/<xsl:value-of select="substring-after(../@name,'src/')"/>/*view*/</xsl:attribute><xsl:value-of disable-output-escaping="yes" select="substring-after(../@name,'src/')"/></a></td>
